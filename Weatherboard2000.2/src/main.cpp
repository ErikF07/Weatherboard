...
//Wifi name/password
const char ssid[] = /*Your wifi name here(in brackets and with Quotation marks)*/;
const char pass[] = /*Your wifi pasword here(in brackets and with Quotation marks)*/;

//Blynk informations
#define BLYNK_TEMPLATE_ID //Your wifi Template id here (with Quotation marks)
#define BLYNK_DEVICE_NAME //Your Device name here (with Quotation marks)
#define BLYNK_AUTH_TOKEN //Your Auth-Token Here (with Quotation marks)
